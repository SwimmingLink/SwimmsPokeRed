...
; Characteristics of each move.
	...
	move KARATE_CHOP,  NO_ADDITIONAL_EFFECT,        50, FIGHTING,     100, 25 ; Changed from Normal Type to match gen' 2+
	...
	move GUST,         NO_ADDITIONAL_EFFECT,        40, FLYING,       100, 35 ; Changed from Normal Type to match gen' 2+
	...
	move SAND_ATTACK,  ACCURACY_DOWN1_EFFECT,        0, GROUND,       100, 15 ; Changed from Normal Type to match gen' 2+
	...
	move BITE,         FLINCH_SIDE_EFFECT1,         60, DARK,         100, 25 ; Changed from Normal Type to match gen' 2+
	...
	move GROWTH,       SPECIAL_UP1_EFFECT,           0, GRASS,        100, 40 ; Changed from Normal Type
